...
class Config(object):
    ...
    OWNER_ID = 6494633110 # If you dont know, run the bot and do /id in your private chat with it, also an integer
    
    SUPPORT_CHAT = "its_Punjabi_Chat_Group"  # Your own group for support, do not add the @
    START_IMG = ""
