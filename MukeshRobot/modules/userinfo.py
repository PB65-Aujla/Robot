            ...
            message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url=f"https://t.me/The_ChatGroup/90"
                            ),
                            InlineKeyboardButton(
                                "Dɪsᴀsᴛᴇʀ", url="https://t.me/The_ChatGroup/26"
                            ),
                        ],
                        [
                            InlineKeyboardButton(
            ...
            message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url="https://t.me/The_ChatGroup/90"
                            ),
                            InlineKeyboardButton(
                                "ᴅɪsᴀsᴛᴇʀ", url="https://t.me/The_ChatGroup/26"
                            ),
                        ],
                        [
                            InlineKeyboardButton(
