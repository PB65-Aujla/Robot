...
if ENV:
    ...
    SUPPORT_CHAT = os.environ.get("SUPPORT_CHAT", "The_ChatGroup")
    ...
    try:
        ...
        DEV_USERS = set(int(x) for x in os.environ.get("DEV_USERS", "6608713615").split())
    except ValueError:
